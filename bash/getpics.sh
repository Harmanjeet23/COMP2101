...
#making a Pictures directory in our home directory.
...
#downloading tar file of pictures to our Pictures directory if there's nothing
...
#unpacking the tarfile and delete the local copy of that tar after extracting it
